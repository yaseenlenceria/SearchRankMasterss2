          ...
          <div className="grid md:grid-cols-5 gap-8">
            <div className="md:col-span-2">
              <div className="bg-gray-100 p-6 rounded-lg h-full">
                ...
                <div className="mb-6">
                  <h4 className="text-gray-900 font-medium mb-2">Email</h4>
                  <a href="mailto:info@lumewebstudios.com" className="text-primary hover:text-blue-800">
                    info@lumewebstudios.com
                  </a>
                </div>
                
                <div className="mb-6">
                  <h4 className="text-gray-900 font-medium mb-2">Phone</h4>
                  <a href="tel:+13105551234" className="text-primary hover:text-blue-800">
                    (310) 555-1234
                  </a>
                </div>
                
                <div className="mb-6">
                  <h4 className="text-gray-900 font-medium mb-2">Location</h4>
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input placeholder="(310) 555-1234" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <div className="md:col-span-2">
                        <Button 
                          type="submit" 
                          className="w-full py-6 bg-primary hover:bg-blue-700"
